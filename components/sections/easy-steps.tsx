...
export function EasySteps() {
  return (
    <section id="about" className="relative py-4 md:py-8 bg-white overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl mb-6 px-4" style={{ fontFamily: 'var(--font-fredoka)' }}>
            ...
            is a modern global real-estate marketplace that puts the world’s homes at your fingertips—discover, connect, and dream in just a tap
          </h1>
        </motion.div>
