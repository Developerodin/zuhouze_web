  ...
  return (
    <section id="properties" className="py-4 md:py-10 bg-white mt-20">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-10">
        ...
        {/* Property Images - 4 Images Grid */}
        <motion.div
          className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-4 xl:gap-3 2xl:gap-3 mb-12"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.6 }}
          viewport={{ once: true }}
        >
          ...
          >
            <div className="relative w-full rounded-2xl overflow-hidden">
              <Image
                src={locationImages[activeLocation as keyof typeof locationImages].third}
                alt={`${activeLocation} Property 3`}
                width={100}
                height={100}
                className="w-full"
              />
          ...
          >
            <div className="relative w-full overflow-hidden">
              <Image
                src={locationImages[activeLocation as keyof typeof locationImages].fourth}
                alt={`${activeLocation} Property 4`}
                width={100}
                height={100}
                className="w-full"
              />
